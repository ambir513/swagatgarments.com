...
export function ProductList() {
  ...
  const [productDeleteValue, setProductDeleteValue] = useState<string>("");
  ...
  const handleDeleteProduct = async (productId: string) => {
    if (productDeleteValue !== "DELETE") {
      toast.error("Please type DELETE to confirm.");
      setProductDeleteValue("");
      return;
    }
            ...
            <div className="flex flex-col gap-3">
              ...
              <div className="hidden md:flex flex-wrap items-center gap-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent className="border-border bg-background text-foreground">
                    <DropdownMenuItem
                      onClick={() => toggleCategoryFilter("MAN")}
                    >
                      <Checkbox
                  ...
                  {paginatedProducts.map((product) => (
                    ...
                    >
                      ...
                      <td className="p-4">
                          ...
                          <AlertDialogContent>
                            ...
                            <div className="">
                              <p className="text-sm text-muted-foreground">
                                Write the word <strong>Delete</strong> to
                                confirm deletion:
                              </p>
                              <Input
                                type="text"
                                className="mt-2 p-2 border border-muted-foreground rounded"
                                placeholder="Enter DELETE to confirm"
                                value={productDeleteValue.toUpperCase().trim()}
                                onChange={(e) =>
                                  setProductDeleteValue(
                        ...
                        <SheetContent className="sm:w-2/4 w-3/4 m-5 rounded-lg">
                          <SheetHeader>
                            <SheetTitle className="flex justify-between items-center mr-10">
                            ...
                            <SheetDescription>
                              This product includes {product.variants.length}{" "}
                              variant(s) and is currently{" "}
